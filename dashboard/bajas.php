...
<div class="container" align= "left">
    <div class="row">
        <div class="col-lg-12">            
        <button id="btnNuevo" type="button" class="btn btn-warning" data-toggle="modal"><i class="material-icons">library_add</i><strong> AÑADIR BAJA</strong></button>                
        </div>   
    </div>    
</div>    
<br> 
        ...
        <form id="formBajas">    
            <div class="modal-body">
                ...
                <div class="row"> 
                    ...
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">JUSTIFICACIÓN</label>
