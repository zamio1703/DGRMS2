...
<head>
    ...
    <title>Bien No Informático</title>
...
<a href="index.php" >
    ...
    <br>
  <div align="center"><h1>BIEN MUEBLE NO INFORMÁTICO</h1></div>
  <br>
       <!-- ### INICIO CONTENIDO ### -->
...
<div class="container" align= "left">
    <div class="row">
        <div class="col-lg-12">            
        <button id="btnNuevo" type="button" class="btn btn-warning" data-toggle="modal"><i class="material-icons">library_add</i><strong>AÑADIR BIEN MUEBLE </strong></button>                
        </div>   
    </div>    
</div>    
<br> 
<!-- tablaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        <table id="examplenoinfo" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
    ...
    <td> <?php echo $infor['cabm'] ?> </td>
    <td> <?php echo $infor['color'] ?> </td>
    <td> <?php echo $infor['material'] ?> </td>
    <td> <?php echo $infor['medidas'] ?> </td>
    <td> <?php echo $infor['modelo'] ?> </td>
    <td> <?php echo $infor['serie'] ?> </td>
   <td> <?php echo $infor['inventario'] ?> </td>
   <td> <?php echo $infor['obs'] ?> </td>
   <td> 
        ...
        <form id="formNoInfo">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <label for="" class="col-form-label">CABM</label>
                    <input type="text" class="form-control" id="cabm">
                    </div>
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                ...
                <div class="row"> 
                    ...
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">Medidas</label>
