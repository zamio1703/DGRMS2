...
<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/css/alertify.min.css"/>
  ...
  <body> 
    ...
    <br>
  <div align="center"><h1>BIEN MUEBLE INFORMÁTICO</h1></div>
  <br>
       <!-- ### INICIO CONTENIDO ### -->
...
<!-- tablaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa -->
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        <table id="exampleinfo" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
    ...
    <td> <?php echo $infor['nombre'] ?> </td>
    <td> <?php echo $infor['color'] ?> </td>
    <td> <?php echo $infor['marca'] ?> </td>
