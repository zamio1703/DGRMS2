...
$resultado->execute();
$cabm=$resultado->fetchAll(PDO::FETCH_ASSOC);
?>
...
<link rel="stylesheet" href="//cdn.jsdelivr.net/npm/alertifyjs@1.13.1/build/css/alertify.min.css"/>
  ...
  <body> 
    ...
    <br>
  <div align="center"><h1>CABM</h1></div>
  <br>
       <!-- ### INICIO CONTENIDO ### -->
...
<div class="container" align= "left">
    <div class="row">
        <div class="col-lg-12">            
        <button id="btnNuevo" type="button" class="btn btn-warning" data-toggle="modal"><i class="material-icons">library_add</i><strong>AÑADIR NUEVO CABM</strong></button>                
        </div>   
    </div>    
</div>    
<br> 
        ...
        <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        <table id="examplecabm" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                        <thead>
                    ...
                    <tbody>
                    <?php
                        foreach($cabm as $cabmv){
                    ?>
                    <tr class="text-center">
    <td> <?php echo $cabmv['id'] ?> </td>
    <td> <?php echo $cabmv['clave'] ?> </td>
    <td> <?php echo $cabmv['partida'] ?> </td>
    <td> <?php echo $cabmv['descripcion'] ?> </td>
    <td> <?php echo $cabmv['factura'] ?> </td>
        ...
        <form id="formCABM">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">Partida específica</label>
                ...
                <div class="row"> 
                    ...
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">No. Factura</label>
